...
const Layout = observer(() => {
    ...
    // OAuth tokens are now handled by runEarlyAuth() in src/main.tsx
    // before React mounts. There is no in-router callback page anymore,
    // so this gate is permanently false.
    const isCallbackPage = false;
